...
import net.xzh.resource.mapper.IamEndpointPolicyMapper;
...
public class EndpointPolicyService {
    ...
    /** 由 controller 分包推导能力域 (net.xzh.resource.controller.admin.Xxx → admin) */
    ...
    private boolean validAuthority(String authority) {
        return Set.of(
                ...
                IamEndpointPolicy.AUTH_CAPABILITY,
