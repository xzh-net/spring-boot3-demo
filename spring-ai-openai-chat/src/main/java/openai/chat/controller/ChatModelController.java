...
public class ChatModelController {
	 ...
	 * {@link org.springframework.ai.openai.OpenAiChatOptions} 优先级高于在
	 * application.yml 中配置的 LLMs 参数！
	 */
	@GetMapping("/custom/chat")
	public String customChat() {

		OpenAiChatOptions customOptions = OpenAiChatOptions.builder().topP(0.7).model("Qwen3-Coder-30B-A3B-Instruct")
				.maxTokens(1000).temperature(0.8).build();
