 ...
 * ------------------------------------
 * 纯前端服务, 不持有 client_secret, 通过调用 iam-portal-service (8100) 后端 API 获取:
...
const PORT = 8200;
const PORTAL_SERVER = 'http://localhost:8100';
...
/** 代理请求到 iam-portal-service (8100), 透传 Cookie */
...
const server = http.createServer(async (req, res) => {
    ...
    // API 代理: 将 /api/* 请求转发到 iam-portal-service (8100)
