package net.xzh.iam.auth.controller.auth;
...
import net.xzh.iam.auth.security.AuthorizationServerConfig;
...
public class LogoutController {
     ...
     * <ul>
     *   <li>post_logout_redirect_uri: 登出后的跳转地址 (必填, 由 iam-portal-service 传入)</li>
    ...
    public void logout(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // 4. 重定向到登出后跳转地址
        // 兼容两种参数名:
        //   - post_logout_redirect_uri: OIDC RP-Initiated Logout 标准参数 (iam-portal-service 使用)
        //   - redirect: 各客户端应用 (iam-client-web-demo / mobile-app) 的自定义参数
