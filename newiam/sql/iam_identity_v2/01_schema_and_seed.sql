-- ============================================================
-- newiam V2 形态 - 认证中心主库 (凭据主库, 并行新库)
-- 数据库: iam_identity_v2
-- 归属: iam-auth-server (协议运行时, 本库唯一写者)
...
CREATE DATABASE IF NOT EXISTS iam_identity_v2
...
INSERT INTO `oauth2_registered_client` VALUES ('2', 'admin-app', '2026-08-13 12:00:00', '$2a$10$ov3NUrdkAHujSRdGbDZF6O9h2cjZq4Zl17fL3TA5Nhs94mE/PmH8e', NULL, '管理后台', 'client_secret_basic', 'refresh_token,authorization_code', 'http://localhost:8101/login/oauth2/code/admin-app', 'http://localhost:8201/logged-out', 'openid,profile,read,write', '{"requireProofKey":false,"requireAuthorizationConsent":false}', '{"accessTokenFormat":"reference","authorizationCodeTimeToLive":"PT5M","accessTokenTimeToLive":"PT2H","reuseRefreshTokens":false,"refreshTokenTimeToLive":"PT12H"}');
INSERT INTO `oauth2_registered_client` VALUES ('3', 'portal-app', '2026-08-11 20:00:08', '$2a$10$ov3NUrdkAHujSRdGbDZF6O9h2cjZq4Zl17fL3TA5Nhs94mE/PmH8e', NULL, '门户应用 (SSO)', 'client_secret_basic', 'refresh_token,authorization_code', 'http://localhost:8100/login/oauth2/code/portal-app-oidc,http://localhost:8300/portal-sso-callback,http://localhost:8302/portal-sso-callback', 'http://localhost:8200/logged-out,http://localhost:8100/logged-out', 'openid,profile,email', '{"requireProofKey":true,"requireAuthorizationConsent":false}', '{"accessTokenFormat":"reference","authorizationCodeTimeToLive":"PT5M","accessTokenTimeToLive":"PT2H","reuseRefreshTokens":false,"refreshTokenTimeToLive":"PT12H"}');
INSERT INTO `oauth2_registered_client` VALUES ('4', 'web-app', '2026-08-11 20:00:08', '$2a$10$ov3NUrdkAHujSRdGbDZF6O9h2cjZq4Zl17fL3TA5Nhs94mE/PmH8e', NULL, 'Web 应用客户端', 'client_secret_basic,client_secret_post', 'authorization_code,refresh_token,password', 'http://localhost:8300/callback,http://127.0.0.1:8300/callback', 'http://localhost:8300/logout', 'openid,profile,email,read,write', '{"requireProofKey":false,"requireAuthorizationConsent":true}', '{"accessTokenFormat":"REFERENCE","accessTokenTimeToLive":"PT2H","reuseRefreshTokens":false,"refreshTokenTimeToLive":"PT12H","idTokenSignatureAlgorithm":"RS256"}');
INSERT INTO `oauth2_registered_client` VALUES ('5', 'device-app', '2026-08-11 20:00:08', NULL, NULL, '设备码客户端', 'none', 'refresh_token,urn:ietf:params:oauth:grant-type:device_code', NULL, NULL, 'openid,profile,email,read', '{"requireProofKey":false,"requireAuthorizationConsent":true}', '{"accessTokenFormat":"REFERENCE","accessTokenTimeToLive":"PT1H","reuseRefreshTokens":false,"refreshTokenTimeToLive":"PT12H"}');
INSERT INTO `oauth2_registered_client` VALUES ('6', 'mobile-app', '2026-08-11 20:00:08', NULL, NULL, '移动应用客户端(PKCE)', 'none', 'authorization_code,refresh_token', 'com.example.mobileapp://oauth2/redirect,http://localhost:8302/callback', 'http://localhost:8302/logout', 'openid,profile,email,read,write', '{"requireProofKey":true,"requireAuthorizationConsent":true}', '{"accessTokenFormat":"REFERENCE","accessTokenTimeToLive":"PT2H","reuseRefreshTokens":false,"refreshTokenTimeToLive":"PT12H","idTokenSignatureAlgorithm":"RS256"}');
