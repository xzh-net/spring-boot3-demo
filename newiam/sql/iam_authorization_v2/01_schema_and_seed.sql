-- ============================================================
-- newiam V2 形态 - 权限中心业务库 (RBAC + 资产域 + 统一准入策略, 并行新库)
-- 数据库: iam_authorization_v2
-- 归属: iam-access-service (本库唯一写者)
...
--         iam_endpoint_policy / iam_client_policy (开放能力两表已迁 iam_open)  (共 10 表)
...
CREATE DATABASE IF NOT EXISTS iam_authorization_v2
    DEFAULT CHARACTER SET utf8mb4
    DEFAULT COLLATE utf8mb4_unicode_ci;

USE iam_authorization_v2;
...
(1, 2, 'WEB',    'Web 门户', 'http://localhost:8300', NULL, 0, NULL, 1, 1, 1, '2026-08-15 10:00:00', '2026-08-15 10:00:00'),
(2, 2, 'MOBILE', '移动门户', 'http://localhost:8301', NULL, 0, NULL, 0, 2, 1, '2026-08-15 10:00:00', '2026-08-15 10:00:00');
...
-- ----------------------------
-- Table structure for iam_client_policy (客户端登录边界策略, 自 iam_identity 迁入 [S5 归位])
-- 说明: 策略规则与角色事实 (sys_user_role) 首次同库, 登录准入在权限中心本地闭环,
--       认证中心经 /api/internal/access/decide 问询裁决结果 (SWR 缓存)。
-- ----------------------------
DROP TABLE IF EXISTS `iam_client_policy`;
CREATE TABLE `iam_client_policy`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `client_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '客户端ID (逻辑引用认证中心 oauth2_registered_client.client_id, 非FK)',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '客户端登录边界策略表 (规则与事实同库, PDP 本地闭环)' ROW_FORMAT = Dynamic;
