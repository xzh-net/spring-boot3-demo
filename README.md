...
- [Spring AI 实现对话问答的两种方式](https://github.com/xzh-net/spring-boot3/tree/main/spring-ai-openai-chat)

- [Spring AI 提示词模板配置](https://github.com/xzh-net/spring-boot3/tree/main/spring-ai-openai-chat-prompt)
...
- [集成 Milvus 实现向量化检索](https://github.com/xzh-net/spring-boot3/tree/main/spring-ai-milvus)
