...
import net.xzh.agent.client.NacosA2aAgentClient;
import net.xzh.agent.client.SimpleA2aAgentClient;
 ...
 *     }
 *   }'}</li>
 *   <li>Or run {@link SimpleA2aAgentClient#main(String[])} and input question like: {@code Hello, please calculate the 346 * 47}</li>
 * </ol>
 *
 ...
 *     <li>Run this application</li>
 *     <li>Run Example {@link NacosA2aAgentClient#main(String[])} and input question like: {@code Hello, please calculate the 346 * 47}</li>
 * </ol>
 */
