 ...
 * 页面跳转控制器.
 * <p>
 * 处理 OAuth2 登录成功后的跳转。前后端分离架构下, portal-server 不持有任何页面,
 * 登出完成页由 portal-app 前端 (8000) 处理。
 */
@Controller
public class PageController {
     ...
     * 然后重定向到 portal-app 前端 (8000) 的门户首页。
     */
    @GetMapping("/api/auth/callback-success")
    public String callbackSuccess() {
        return "redirect:http://localhost:8000/portal.html";
    }
}
