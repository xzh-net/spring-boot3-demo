 ...
 *
 * <p>portal-server 作为 BFF (Backend For Frontend)，职责：</p>
 * <ul>
 *   <li>处理 OAuth2 授权码登录流程（持有 client_secret）</li>
 *   <li>提供 REST API 给 portal-app 前端 (8000) 调用</li>
 ...
 *
 * <p><b>登出流程：</b>portal-app 前端通过 302 GET 重定向到 /api/auth/logout,
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                // CORS: 允许 portal-app 前端 (8000) 跨域调用
                ...
                .logout(logout -> logout
                        // 1. 支持 GET 请求登出 (portal-app 前端通过 302 重定向到此 URL)
    ...
    /**
     * CORS 配置: 允许 portal-app 前端 (8000) 跨域调用本服务 (8080) 的 API。
